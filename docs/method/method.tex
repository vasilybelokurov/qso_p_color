...
equally. Narrower slices reduce the residual at the cost of statistics. The redshift resolution becomes an explicit, tunable
...
stay in the denominator, or sparse bins are biased high. Using the nominal cell area instead would bias the density
...
discrimination is genuinely hardest. The figure therefore shows dynamic range,
not an operating characteristic. The quasar
