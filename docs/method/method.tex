...
\end{equation}
%
Broadband colours constrain a quasar redshift to $\sigma_z$ of order $0.1$, and
often to a multimodal distribution rather than a single peak --- which is why
XDQSOz produces a redshift \emph{PDF} in the first place
\citep{bovy2012xdqsoz}. The window is therefore roughly an order of magnitude
narrower than the measurement. Figure~\ref{fig:window} shows this directly for
three real quasars.
...
narrow orange band. Integrating that band against this posterior is what
...
$3.0$ overlap substantially, and in the $\sigma_z\approx0.29$ of
